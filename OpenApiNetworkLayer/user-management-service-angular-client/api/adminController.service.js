...
exports.AdminControllerService = void 0;
...
let AdminControllerService = class AdminControllerService {
    ...
    deleteUser(email, observe = 'body', reportProgress = false, options) {
    ...
    getAllUsers(page, size, observe = 'body', reportProgress = false, options) {
        let localVarQueryParameters = new http_1.HttpParams({ encoder: this.encoder });
    ...
    getUser(email, observe = 'body', reportProgress = false, options) {
        if (email === null || email === undefined) {
    ...
    makeUserAdmin(email, observe = 'body', reportProgress = false, options) {
        if (email === null || email === undefined) {
    ...
    removeUserAdmin(email, observe = 'body', reportProgress = false, options) {
        if (email === null || email === undefined) {
...
exports.AdminControllerService = AdminControllerService = __decorate([
    (0, core_1.Injectable)({
        providedIn: 'root'
    }),
