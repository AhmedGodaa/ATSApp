...
exports.PasswordResetControllerService = void 0;
...
let PasswordResetControllerService = class PasswordResetControllerService {
    ...
    requestPasswordReset(email, observe = 'body', reportProgress = false, options) {
    ...
    resetPassword(resetPasswordRequest, observe = 'body', reportProgress = false, options) {
...
exports.PasswordResetControllerService = PasswordResetControllerService;
exports.PasswordResetControllerService = PasswordResetControllerService = __decorate([
    (0, core_1.Injectable)({
        providedIn: 'root'
    }),
